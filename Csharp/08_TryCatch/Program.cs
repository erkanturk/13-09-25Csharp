namespace _08_TryCatch
{
    internal class Program
    {
        ...
        {
            /* TryCatch: Fırlatılan Exception'ları yakalayarak 
             * programın akışını durdurmadan hata durumunda ne yapılması gerektiğini tanımlarız
             * TryCatch yapıları syntax hatalarını yakalamaz
             * bu tip hatalar build kısmında yani sistem çalıştırılırken derleme tarafında hatayı gösterir 
